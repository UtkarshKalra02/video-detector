...
class Detector:
    ...
    def onVideo(self):
        ...
        while success:
            ...
            classLabelIDs, confidences, bboxs = self.net.detect(image,
                                                                confThreshold=0.4)
            bboxs = list(bboxs)
            ...
            if len(bboxIdx) != 0:
                for i in range(0, len(bboxIdx)):
                    ...
                    classLabel = self.classesPath[classLabelID]
                    ...
                    cv2.line(image,(x+w,y+h), (x, y+ h - lineWidth), classColor, thickness=5)
